...
#+BEGIN_SRC sh
  curl -OL "https://github.com/bohonghuang/sbcl-termux-build/releases/download/2.3.2/sbcl-2.3.2-arm64-termux.tar.zst"
  unzstd -c "sbcl-2.3.2-arm64-termux.tar.zst" | tar -xf -
  cd "sbcl-2.3.2"
#+END_SRC
